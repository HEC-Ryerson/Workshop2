const int echo = 7;                                           // Define the echo pin as a constant integer, so it cant be changed
const int trig = 8;                                           // Define the trigger pin as a constant integer, so it cant be changed
const int led = 9;

int maxRange = 200;                                           // Set maximum range to 200 cm
int minRange = 0;                                             // Set minimum range to 0 cm
//int i = 0, j = 0;                                             // Counters
long distance1, distance2, duration;                                      // create long variables for distance and duration
...
/*FILTERING:
  ...
  */
  ...
  Serial.println(distance);                                   // Sends the distance in cm to the serial monitor if it is within range
